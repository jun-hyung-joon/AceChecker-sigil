...
A Sigil plugin that validates EPUB files using [Ace by DAISY](https://github.com/daisy/ace), providing detailed accessibility reports and warnings directly within the Sigil editor. The plugin automatically detects and uses the installed version of Ace by DAISY, checks for updates, and ensures you're always aware of the latest accessibility standards.
...
3. The plugin will:
   * Check for [Ace by DAISY](https://github.com/daisy/ace) installation
   * Check for available updates
   * Generate a temporary EPUB file
   * Run accessibility validation using [Ace by DAISY](https://github.com/daisy/ace)
   * Display detailed accessibility results

**Note**: The plugin will notify you when newer versions of [Ace by DAISY](https://github.com/daisy/ace) are available and provide update instructions.
